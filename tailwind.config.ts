    ...
    extend: {
      ...
      keyframes: {
        ...
        "glitch-3": {
          ...
          "25%": { transform: "translate(4px, 0)", opacity: "0.6" },
          "50%": { transform: "translate(-4px, 0)", opacity: "0.9" },
      ...
      animation: {
        ...
        "glitch-2": "glitch-2 0.3s ease-in-out 0.05s infinite",
        "glitch-3": "glitch-3 0.25s ease-in-out 0.1s infinite",
      },
    },
  },
